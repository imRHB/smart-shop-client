...
const CustomerInvoice = () => {
  ...
  return (
    <Container>
      <Box
        sx={{ mt: 5, bgcolor: "white", position: "relative" }}
      ...
      >
          ...
          <Grid item xs={6}>
            <Box>
              <Typography sx={{ textAlign: "left" }}>
                Bill TO: MD Zahid Hasan
              </Typography>

              <Typography sx={{ textAlign: "left" }} variant="body1">
                Phone Number: +8801646190607
              </Typography>

              <Typography sx={{ textAlign: "left" }} variant="body1">
                Address: 59 GM Bari Wasa Masjid road
              </Typography>
            </Box>
          </Grid>
          <Grid item xs={6}>
        ...
        <Container sx={{ width: "100%", my: 5 }}>
          <Box className={`${styles.tableContainer}`}>
            ...
            <Typography
              sx={{ textAlign: "left", mt: 8, mb: 3, fontWeight: "bold" }}
            >
              Prepared By: Hasan Zahid
            </Typography>

            <Typography sx={{ textAlign: "left" }}>
              Smart Shop | Dhaka,Bangladesh <br />{" "}
              https://smart-shop-pos.web.app{" "}
            </Typography>
          </Box>
        </Container>
        <Typography
