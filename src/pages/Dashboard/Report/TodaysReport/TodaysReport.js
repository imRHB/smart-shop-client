    ...
    return (
        <Container sx={{ width: "100%", mb: 5 }}>
            <Box className={`${styles.topContainer}`} sx={{ display: "flex", my: 3 }}>
                ...
                <Typography>
                    <span style={{ fontSize: "26px" }}>
                        Todays Report</span> <br />{" "}
                    <span style={{ color: "#969494" }}>Todays sales and purchase report</span>
                </Typography>
            </Box>
            ...
            <Box className={`${styles.tableContainer}`} sx={{ mt: 2 }}>
                <Typography sx={{ fontWeight: "bold" }}>Todays Purchase Report</Typography>
                <hr />
                <TableContainer
                    component={Paper}
                    sx={{ border: 1, borderColor: "grey.300" }}
                >
                    <Table aria-label="simple table">
                        <TableHead className={`${styles.tableHeader}`}>
                            <TableRow>
                                <TableCell align="left" className={`${styles.tableCell}`}>Purchase Date</TableCell>
                                <TableCell align="left" className={`${styles.tableCell}`}>
                                    Sell No
                                </TableCell>
                                <TableCell align="left" className={`${styles.tableCell}`}>
                        ...
                        <TableBody>
                            <TableRow>
                                <TableCell colSpan={3} align="right" sx={{ borderRight: 1 }}>Total Purchase:</TableCell>
                                <TableCell align="right">Dynamic total </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
