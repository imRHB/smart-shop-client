    ...
    return (
        <Container sx={{ width: "100%", mb: 5 }}>
            <Box className={`${styles.topContainer}`} sx={{ display: "flex", my: 3 }}>
                ...
                <Typography>
                    <span style={{ fontSize: "26px" }}>Sales Report (Product Wise)</span> <br />{" "}
                    <span style={{ color: "#969494" }}>Sales Report (Product Wise)</span>
                </Typography>
            </Box>
            <Box className={`${styles.tableContainer}`}>
                <Typography sx={{ fontWeight: "bold" }}>Sales Report (Product Wise)</Typography>
                <hr />
                <TableContainer
                    component={Paper}
                ...
                >
                    <Table aria-label="simple table">
                        <TableHead className={`${styles.tableHeader}`}>
                            <TableRow>
                                <TableCell className={`${styles.tableCell}`}>Sales Date	</TableCell>
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                <TableCell colSpan={5} align="right" sx={{ borderRight: 1 }}>Total Purchase:</TableCell>
