    ...
    return (
        <React.Fragment>
            <TableRow className="colunm" sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
               ...
               <Button>
               <EditIcon sx={{marginLeft:'25px', backgroundColor:'green', borderRadius:'5px', color:'yellow'}} /> 
               </Button>

            <Button>
            <DeleteForeverIcon sx={{ backgroundColor:'red', borderRadius:'5px', color:'white'}}/>
            </Button>
                    </TableCell>
            </TableRow>
    ...
    return (
        <Box >
           ...
           <div className='d-flex justify-content-between  border'>
                ...
                <div>
                    <small className='text-primary fw-bold border p-1'>Add Expense Item</small>
                </div>
                ...
                <Box sx={{ borderBottom: '1px solid lightGray' }}>
                  ...
                  Expense Item
                    ...
                    <Box sx={{display:'flex', padding:'5px'}}>
                        <Typography variant="small" sx={{margin:'10px', fontWeight:'bold' , color:'gray'}}>
                            Search 
                        </Typography>
                    ...
                    <Table aria-label="simple table">
                        <TableHead>
                            <TableRow className="colunm">
                                ...
                                <TableCell sx={{fontWeight:'bold'}} align="center">Expense Item</TableCell>
