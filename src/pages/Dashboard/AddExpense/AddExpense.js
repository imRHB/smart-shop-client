  ...
  return (
    <Container sx={{ width: "100%", mb: 5 }}>
      <Box className={`${styles.topContainer}`} sx={{ display: "flex", my: 3 }}>
        ...
        <Typography>
          <span style={{ fontSize: "26px" }}>Expense Item</span> <br />
          <span style={{ color: "#969494" }}>Add Expense</span>
        </Typography>
      </Box>
      <Box sx={{ textAlign: "right", my: 2 }}>
        <Link to="manageExpense">
        <Button className={`${styles.manageEmployeeBtn}`}>Manage Expense</Button>
        </Link>
      </Box>
      <Box className={`${styles.tableContainer}`}>
        <Typography sx={{ fontWeight: "bold" , textAlign:'start', marginLeft:'6px'}}>Add Expense Item</Typography>
        <hr />
        <div className="mt-2">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div className="p-3 border bg-light">
                      <div className="mb-3">
                        ...
                        >
                          Expense Name <sup className="text-danger fw-bold fs-6">*</sup>
                        </label>
                        <input
                          type="text"
