    ...
    return (
        ...
        <div className='row'>
            <div  className='col-12 col-lg-6 col-md-6'>
                <div style={{ backgroundColor: 'white', height:'355px' }} className="">
            ...
            <div className='col-12 col-lg-6 col-md-6'>
                ...
                <h6 className='text-start fw-bold p-2'>Order Timeline</h6>
                    ...
                    <small className='line'></small>
                         <small style={{fontSize:'11px', color:'gray'}}  className='ms-4'> 31 May 2021 19:34</small>
                     </div>
                    </div>
                    <div >
                     <div className='d-flex mt-2'>
                    ...
                    <div >
                     <div className='d-flex mt-2'>
                    <FiberManualRecordIcon style={{color:'yellow'}}></FiberManualRecordIcon>
                         <small>1983, orders, $4220</small>
                     </div>
                     <div className='text-start '>
                    <small className='line'></small>
                    ...
                    <div >
                     <div className='d-flex mt-2'>
                    <FiberManualRecordIcon style={{color:'skyblue'}}></FiberManualRecordIcon>
                         <small>1983, orders, $4220</small>
                     </div>
                     <div className='text-start'>
                  
                         <small style={{fontSize:'11px'}} className='ms-4 text-secondary'> 31 May 2021 19:34</small>
                     </div>
                    </div>
                </div>
